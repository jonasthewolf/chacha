...
unittest {
	...
	auto block = c.get_next_block();
	auto writer = appender!string();
	foreach ( uint b ; block) {
			formattedWrite(writer, "%08x ", read_as_little_endian(b));
	}
	auto actualBlock = writer.data;
	writeln(actualBlock);
	auto expectedBlock = "76b8e0ad a0f13d90 405d6ae5 5386bd28 bdd219b8 a08ded1a a836efcc 8b770dc7 da41597c 5157488d 7724e03f b8d84a37 6a43b8f4 1518a11c c387b669 b2ee6586";
	writeln(expectedBlock);
	assert (actualBlock == expectedBlock);
}
